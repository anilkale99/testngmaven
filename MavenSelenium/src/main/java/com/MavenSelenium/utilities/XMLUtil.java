...
public class XMLUtil extends Object {
	 ...
	 */
	public static String[] getTextValues(Node n, String path) throws SAXException, TransformerException {
		...
		NodeList nl = XPathAPI.selectNodeList(n, path);
		if (nl == null)
			return xxx;
