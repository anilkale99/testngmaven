...
public class XPathCache {
	...
	public static org.jaxen.XPath createJaxenXPath(String path) throws JaxenException {
		...
		xp.addNamespace("wdk","http://google/XML/WDK");
		xp.addNamespace("wdktags","http://google/XML/WDK/taglib");
		xp.addNamespace("xsp","http://google/1999/XSP/Core");
		xp.addNamespace("rdf","http://google/1999/02/22-rdf-syntax-ns#");
		xp.addNamespace("xsl","http://google/1999/XSL/Transform");
		return xp;
